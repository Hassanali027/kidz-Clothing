...
class AdminController extends Controller
{
    ...
    public function updateBanner(Request $request)
    {
        try {
            $request->validate([
                'banner_type' => 'required|in:hero,cta,category_boys,category_girls,category_baby,category_party',
            ...
            return redirect()->route('admin.home')->with('error', 'Error: ' . $e->getMessage());
        }
    }

    public function categories()
    {
        return view('admin.categories', ['pageTitle' => 'Category Management']);
    }
