...
@media (max-width:768px) {
    ...
    <div class="cu-page">
        ...
        <div class="cu-layout">
            ...
            <div class="cu-info">
                ...
                <div class="cu-info-item">
                    ...
                    <div class="cu-info-text">
                        <h3>Address</h3>
                        <p>Chauburji Chowk, Lahore, 54000, Pakistan</p>
                    </div>
                </div>
        ...
        <div class="cu-map-section">
            <iframe
                src="https://maps.google.com/maps?q=Chauburji%20Chowk,%20Lahore,%2054000,%20Pakistan&t=&z=15&ie=UTF8&iwloc=&output=embed"
                width="100%"
                height="100%"
                style="border:0;"
                allowfullscreen=""
                ...
                title="Kidz Wear Store Location — Lahore">
            </iframe>
        </div>
