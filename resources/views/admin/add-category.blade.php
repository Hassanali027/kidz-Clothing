...
@section('content')
    ...
    <div class="content-card">
        ...
        <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data" class="admin-form">
            @csrf
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="slug" name="slug" class="form-control" value="{{ old('slug') }}" placeholder="Auto-generated from name">
            ...
            <div class="form-group">
                ...
                <small style="color: #666;">Recommended size: 600x400px (JPG, PNG, WEBP - Max 5MB)</small>
            </div>

            <div class="form-group">
                <label for="description">Description</label>
                <textarea id="description" name="description" class="form-control" rows="4" placeholder="Brief description about this category">{{ old('description') }}</textarea>
            </div>
