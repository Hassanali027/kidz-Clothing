        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="admin-form">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="age_group" class="form-control" required>
                        ...
                        <option value="0-2" {{ old('age_group') == '0-2' ? 'selected' : '' }}>0-2 Years</option>
                        <option value="2-5" {{ old('age_group') == '2-5' ? 'selected' : '' }}>2-5 Years</option>
                        <option value="5-8" {{ old('age_group') == '5-8' ? 'selected' : '' }}>5-8 Years</option>
                        <option value="8-14" {{ old('age_group') == '8-14' ? 'selected' : '' }}>8-14 Years</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="size" class="form-control" placeholder="e.g. Small, Medium, Large, or specific dimensions" value="{{ old('size') }}">
                </div>
            </div>
